...
![Cron schedules, webhooks, kickd event and file changes fire events, and kickd runs the command of each event. Every event has a command of its own.](../images/overview.svg)
