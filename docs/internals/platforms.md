...
On macOS and Linux, `kickd init` creates the config file with the permission 0600, and a new queue database gets 0600 as well, because both can hold secrets and command output.
